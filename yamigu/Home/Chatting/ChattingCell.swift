...
class ChattingCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        profileImageView.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -18).isActive = true
        ...
        nameLabel.rightAnchor.constraint(equalTo: profileImageView.leftAnchor, constant: -13).isActive = true
        nameLabel.topAnchor.constraint(equalTo: profileImageView.topAnchor, constant: 0).isActive = true
        
        
        //x,y,w,h
        bubbleView.rightAnchor.constraint(equalTo: profileImageView.leftAnchor, constant: -13).isActive = true
        ...
        timeLabel.rightAnchor.constraint(equalTo: bubbleView.leftAnchor, constant: -6).isActive = true
